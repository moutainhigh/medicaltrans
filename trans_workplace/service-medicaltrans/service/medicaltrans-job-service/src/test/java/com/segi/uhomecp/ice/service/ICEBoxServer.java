...
import com.segi.uhomecp.init.MedicaltransJobIceBoxService;

public class ICEBoxServer {
	
	//修改端口
	private static final int PORT = 6304;
...
//			Ice.Object object = new HelloWorld();
	...
	public static void startServiceByRegCenter(int port,String[] args) {
		...
		try {
			...
			MedicaltransJobIceBoxService def = new MedicaltransJobIceBoxService();
