...
import com.segi.uhomecp.init.MedicaltransDispatchBoxService;

public class ICEBoxServer {
	
	//修改端口
	private static final int PORT = 6302;
...
//			Ice.Object object = new HelloWorld();
	...
	public static void startServiceByRegCenter(int port,String[] args) {
		...
		try {
			...
			MedicaltransDispatchBoxService def = new MedicaltransDispatchBoxService();
