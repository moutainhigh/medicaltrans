...
import com.segi.uhomecp.init.MedicaltransReportBoxService;

public class ICEBoxServer {
	
	//修改端口
	private static final int PORT = 6303;
...
//			Ice.Object object = new HelloWorld();
	...
	public static void startServiceByRegCenter(int port,String[] args) {
		...
		try {
			...
			MedicaltransReportBoxService def = new MedicaltransReportBoxService();
