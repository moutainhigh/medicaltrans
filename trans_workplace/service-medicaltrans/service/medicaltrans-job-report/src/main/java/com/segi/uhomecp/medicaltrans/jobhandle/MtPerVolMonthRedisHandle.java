...
/**
 * @ClassName:  MtPerVolMonthRedisHandle   
 * @Description:刷新个人当月运送量排名缓存Job   
 * @author: zhaoqing
 * @date:   2018年7月30日 下午5:49:42
 */
@JobHandler(value = "MtPerVolMonthRedisHandleJob")
@Component
public class MtPerVolMonthRedisHandle extends IJobHandler {
	...
	public ReturnT<String> execute(String arg0) throws Exception {
		...
		try {
			...
			// 业务处理
			ResultInfo result = mtPerVolMonthRptHandleUtils.redisJobhandle(groupOrganMap);
			if (result.getIsSucc()) {
				return SUCCESS;
			} else {
