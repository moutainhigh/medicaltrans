...
public class MtTaskPageIce implements java.lang.Cloneable, java.io.Serializable
{
    ...
    getIsTimeOutName()
    {
        return isTimeOutName;
    }

    public void
    setIsTimeOutName(String _isTimeOutName)
    {
        isTimeOutName = _isTimeOutName;
    }
    ...
    public MtTaskPageIce(String taskId, String organId, String organName, String createDate, String createBy, String createByName, String sourceHouseId, String sourceHouseName, String transTypeParentCode, String transTypeParentCodeName, String urgency, String urgencyName, String fromHouseId, String fromHouseName, String toHouseId, String toHouseName, java.util.List<ExeUser> userList, String taskType, String taskTypeName, String resType, String resTypeName, String status, String statusName, String sendTime, String beginTime, String endTime, String exeBeginTime, String exeEndTime, String dataSource, String isTimeOut, String isTimeOutName, String groupOrganId, String dispatchUserId, String dispatchUserName, String taskContent, String receiver, String receiverUserName, String receiveTime, String evaluate, String evaluateContent)
    {
        this.taskId = taskId;
        ...
        this.isTimeOutName = isTimeOutName;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        MtTaskPageIce _r = null;
        if(rhs instanceof MtTaskPageIce)
        {
            _r = (MtTaskPageIce)rhs;
        }
        ...
        if(_r != null)
        {
            ...
            if(isTimeOutName != _r.isTimeOutName)
            {
                if(isTimeOutName == null || _r.isTimeOutName == null || !isTimeOutName.equals(_r.isTimeOutName))
                {
                    return false;
                }
            }
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::segi::medicaltrans::mthistask::query::MtTaskPageIce");
        ...
        __h = IceInternal.HashUtil.hashAdd(__h, isTimeOutName);
    ...
    clone()
    {
        MtTaskPageIce c = null;
        try
        {
            c = (MtTaskPageIce)super.clone();
        }
    ...
    __write(IceInternal.BasicStream __os)
    {
        ...
        __os.writeString(isTimeOutName);
    ...
    static public void
    __write(IceInternal.BasicStream __os, MtTaskPageIce __v)
    {
        if(__v == null)
        {
    ...
    static public MtTaskPageIce
    __read(IceInternal.BasicStream __is, MtTaskPageIce __v)
    {
        if(__v == null)
        {
             __v = new MtTaskPageIce();
        }
        __v.__read(__is);
        return __v;
    }
    
    private static final MtTaskPageIce __nullMarshalValue = new MtTaskPageIce();

    public static final long serialVersionUID = -17110162L;
}
