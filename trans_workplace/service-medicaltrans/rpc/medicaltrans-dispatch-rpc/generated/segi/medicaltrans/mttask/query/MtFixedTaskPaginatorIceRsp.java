...
public class MtFixedTaskPaginatorIceRsp implements java.lang.Cloneable, java.io.Serializable
{
    public String code;
    ...
    public java.util.List<MtFixedTaskPageIce> resultList;

    public java.util.List<MtFixedTaskPageIce>
    getResultList()
    {
        return resultList;
    }
    ...
    public void
    setResultList(java.util.List<MtFixedTaskPageIce> _resultList)
    {
        resultList = _resultList;
    }

    public MtFixedTaskPaginatorIceRsp()
    {
        code = "";
        message = "";
    ...
    public MtFixedTaskPaginatorIceRsp(String code, String message, page.RpcPageIce paginator, TaskCount taskCount, java.util.List<MtFixedTaskPageIce> resultList)
    {
        this.code = code;
    ...
    equals(java.lang.Object rhs)
    {
        ...
        MtFixedTaskPaginatorIceRsp _r = null;
        if(rhs instanceof MtFixedTaskPaginatorIceRsp)
        {
            _r = (MtFixedTaskPaginatorIceRsp)rhs;
        }
    ...
    {
        int __h = 5381;
        __h = IceInternal.HashUtil.hashAdd(__h, "::segi::medicaltrans::mttask::query::MtFixedTaskPaginatorIceRsp");
    ...
    clone()
    {
        MtFixedTaskPaginatorIceRsp c = null;
        try
        {
            c = (MtFixedTaskPaginatorIceRsp)super.clone();
        }
    ...
    __write(IceInternal.BasicStream __os)
    {
        ...
        FixedTaskPageListHelper.write(__os, resultList);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        resultList = FixedTaskPageListHelper.read(__is);
    }

    static public void
    __write(IceInternal.BasicStream __os, MtFixedTaskPaginatorIceRsp __v)
    {
        if(__v == null)
        {
    ...
    static public MtFixedTaskPaginatorIceRsp
    __read(IceInternal.BasicStream __is, MtFixedTaskPaginatorIceRsp __v)
    {
        if(__v == null)
        {
             __v = new MtFixedTaskPaginatorIceRsp();
        }
        __v.__read(__is);
        return __v;
    }
    
    private static final MtFixedTaskPaginatorIceRsp __nullMarshalValue = new MtFixedTaskPaginatorIceRsp();

    public static final long serialVersionUID = -1461367964L;
}
