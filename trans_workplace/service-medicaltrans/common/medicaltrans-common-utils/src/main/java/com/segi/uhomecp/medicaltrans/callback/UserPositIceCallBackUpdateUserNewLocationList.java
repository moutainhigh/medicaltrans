...
import segi.medicaltrans.common.userposit.Callback_MtUserPositCommonServiceIce_updateUserNewLocationList;

public class UserPositIceCallBackUpdateUserNewLocationList
			extends Callback_MtUserPositCommonServiceIce_updateUserNewLocationList {
