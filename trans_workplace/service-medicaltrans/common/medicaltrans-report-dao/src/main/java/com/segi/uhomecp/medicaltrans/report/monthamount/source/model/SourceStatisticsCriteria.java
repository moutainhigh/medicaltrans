...
public class SourceStatisticsCriteria extends AbstractCriteria {
    
	/**  描述   (@author: yangyh@segimail.com) */      
	private static final long serialVersionUID = -5844555329417612927L;
    ...
    public SourceStatisticsCriteria() {
